...
import {
  Palette, Type, Grid3x3, Layers, ArrowLeft, Sun, Moon,
  CheckCircle2, AlertCircle, Sparkles, Bell,
  User, Mail, Lock, ExternalLink
} from 'lucide-react';
...
export const DesignSystem: React.FC = () => {
  ...
  const { roles, theme, setTheme } = useColorStore();
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ height: '20px', width: '1px', background: 'var(--md-ref-role-outlineVariant)' }} />
          <span style={{ fontWeight: 700, fontSize: '1.125rem' }}>Matisse Design System Explorer</span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <GlossyButton size="sm" onClick={() => navigate('/color-builder')}>
            <Palette size={16} />
            Color Builder
          </GlossyButton>
        </div>
                ...
                <Card variant="outlined" padding="lg">
                  ...
                  <div style={{ marginTop: '1rem' }}>
                    ...
                    <Modal
                      ...
                      title="Matisse Design System Modal"
                      footer={
                        <>
                          <GlossyButton variant="outline" size="sm" onClick={() => setIsModalOpen(false)}>Cancel</GlossyButton>
                          <GlossyButton size="sm" onClick={() => { setIsModalOpen(false); showToast('success', 'Confirmed!'); }}>Confirm</GlossyButton>
                        </>
                      }
                    >
                      <p style={{ margin: 0, fontSize: '0.875rem', lineHeight: 1.6, color: 'var(--md-ref-role-onSurfaceVariant)' }}>
                        This is a dynamic modal container bound to your theme. It disables backdrop scroll and adapts instantly to light/dark toggling.
                      </p>
                    </Modal>
                  </div>
                </Card>
