...
const industryMeta: Record<string, { label: string; description: string; colorTokens: { name: string; value: string }[] }> = {
  FinTech: {
    label: 'FinTech',
    description: 'Professional, trustworthy color recommendations for financial technology products.',
    colorTokens: [
...
const designSections = [
  { icon: <Palette size={16} />, label: 'Color Palette', desc: 'Primary, secondary, and accent colors' },
  { icon: <Type size={16} />, label: 'Typography', desc: 'Font families and scale recommendations' },
  ...
  return (
    <div className="dr-root">
      <header className="dr-header">
        <button className="dr-header__back-btn" onClick={() => navigate('/dashboard')} aria-label="Go back">
          <ArrowLeft size={16} />
      ...
      <div className="dr-body">
        ...
        <div className="dr-section">
          ...
          <p className="dr-section__desc">These are the token categories we'll configure for the {meta.label} industry.</p>
        ...
        <div className="dr-actions">
          ...
          <GlossyButton variant="primary" size="md" icon={<Sparkles size={14} />} iconPosition="left">
